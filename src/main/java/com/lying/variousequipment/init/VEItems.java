...
public class VEItems
{
	...
	public static final Item LEGS_PEG_WOODEN	= register("legs_peg_wooden", new ItemPegLeg(new Item.Properties()));
	public static final Item LEGS_PEG_IRON		= register("legs_peg_iron", new ItemPegLeg(new Item.Properties()));
	public static final Item LEGS_PEG_GOLDEN	= register("legs_peg_golden", new ItemPegLeg(new Item.Properties()));
	public static final Item LEGS_PEG_NETHERITE	= register("legs_peg_netherite", new ItemPegLeg(new Item.Properties()));
