...
{
	public static final ResourceLocation TEXTURE = new ResourceLocation(Reference.ModInfo.MOD_ID, "textures/entities/scarecrow.png");
	public static final ResourceLocation TEXTURE_BURNT = new ResourceLocation(Reference.ModInfo.MOD_ID, "textures/entities/burnt_scarecrow.png");
